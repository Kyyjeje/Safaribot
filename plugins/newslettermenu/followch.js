...
module.exports = {
    name: 'followchanel',
    alias: ['followch','followchanel','chfollow','chanelfollow','joinch','joinchanel','followch',],
    ...
    run: async ({ naze, m }) => {
        ...
        try {
            ...
            await naze.newsletterFollow(jid);
            await naze.sendMessage(m.chat, {
                text: `🎉 *Berhasil Mengikuti Newsletter, Yang Mulia!*\n\n` +
                      `📢 *Channel*: ${channelName}\n` +
                      `🔗 *JID*: ${jid}\n` +
                      `✅ Sekarang Anda mengikuti channel ini!`,
                contextInfo: {
