...
module.exports = {
    ...
    run: async ({ naze, m }) => {
        try {
            ...
            const datas = words.map(word => /[\u{1F300}-\u{1F6FF}\u{1F900}-\u{1F9FF}\u{2600}-\u{26FF}\u{2700}-\u{27BF}]/u.test(word) ? 'black' : 'black');
            ...
            function drawJustifiedText(lines, fontSize, maxWidth, startY) {
            ...
            if (wordCount === 1) {
                ...
                drawJustifiedText(lines, fontSize, maxWidth, startY);
            }
            ...
            console.error(`Fatal error di brat2: ${e.message}\nStack: ${e.stack}`);
