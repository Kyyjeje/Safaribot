...
const fallbackQuestions = [
    { soal: "Ada uang ada ... ", jawaban: "barang" },
    { soal: "Bersihkan sebelum ... ", jawaban: "kotor" }
];
...
module.exports = {
    ...
    run: async ({ naze, m }) => {
        ...
        let soal, jawaban;
        try {
            const response = await fetch('https://api.siputzx.my.id/api/games/tebakkalimat', {
                headers: {
            ...
            console.error("[ERROR] Gagal mengambil soal tebak kalimat:", e.message);
        ...
        try {
            ...
            const timerId = setTimeout(async () => {
                games = loadGames();
                if (games[m.chat] && games[m.chat].gameName === 'tebakkalimat') {
            ...
            console.error("[ERROR] Gagal memulai permainan tebak kalimat:", e);
